  ...
  return (
    ...
    >
      ...
      <h1 className="animate-rise m-0 mb-6.5 max-w-[15em] text-[clamp(3.25rem,8.2vw,8.25rem)] leading-[0.88] tracking-[-0.028em] text-panel-foreground">
        {t.rich("title", {
          accent: (chunks) => <span className="brand-text">{chunks}</span>,
        })}
      </h1>
      ...
      <div className="grid items-end gap-14 pb-14 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <figure className="blueprint blueprint-panel m-0 aspect-[5/3.2] bg-white/6 text-accent-300">
          <Corners />
          <MediaPlaceholder label={t("mediaLabel")} onPanel />
        </figure>
      </div>
    </section>
  );
